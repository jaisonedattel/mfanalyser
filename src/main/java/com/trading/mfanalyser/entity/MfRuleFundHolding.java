...
@Entity
@Table(name = "T_MF_RULE_FUND_HOLDING", schema = "APP")
public class MfRuleFundHolding {
	...
	public MfRuleFund getMfRuleFund() {
		return mfRuleFund;
	}

	public void setMfRuleFund(MfRuleFund mfRuleFund) {
	...
	public String toString() {
		return "MfRuleFundHolding [holdingId=" + holdingId + ", mfRuleFund=" + mfRuleFund.getFundId() + ", ruleId=" + ruleId
				+ ", stockName=" + stockName + ", amfiCode=" + amfiCode + "]";
	}
